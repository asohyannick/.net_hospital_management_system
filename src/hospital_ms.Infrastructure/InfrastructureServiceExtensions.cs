using hospital_ms.Core.Interfaces;
using hospital_ms.Core.Services;
using hospital_ms.Infrastructure.Data;
using hospital_ms.Infrastructure.Data.Queries;
using hospital_ms.UseCases.Contributors.List;

namespace hospital_ms.Infrastructure;
