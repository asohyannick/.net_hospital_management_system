...
1. Set `hospital_ms.AspireHost` as the startup project
...
```bash
dotnet ef migrations add MigrationName -c AppDbContext -p ../hospital_ms.Infrastructure/hospital_ms.Infrastructure.csproj -s hospital_ms.Web.csproj -o Data/Migrations
```

To update the database:
```bash
dotnet ef database update -c AppDbContext -p ../hospital_ms.Infrastructure/hospital_ms.Infrastructure.csproj -s hospital_ms.Web.csproj
```
