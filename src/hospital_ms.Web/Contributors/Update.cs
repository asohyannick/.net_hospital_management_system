...
using hospital_ms.UseCases.Contributors;
using hospital_ms.UseCases.Contributors.Get;
using hospital_ms.UseCases.Contributors.Update;
using hospital_ms.Web.Extensions;
using Microsoft.AspNetCore.Http.HttpResults;

namespace hospital_ms.Web.Contributors;
