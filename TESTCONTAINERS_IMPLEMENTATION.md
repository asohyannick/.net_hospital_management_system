...
**Updated `tests\hospital_ms.FunctionalTests\hospital_ms.FunctionalTests.csproj`:**
- Removed: `Microsoft.EntityFrameworkCore.InMemory`
- Added: `Testcontainers` and `Testcontainers.MsSql`

### 2. CustomWebApplicationFactory

**File:** `tests\hospital_ms.FunctionalTests\CustomWebApplicationFactory.cs`
...
```bash
dotnet test tests\hospital_ms.FunctionalTests\hospital_ms.FunctionalTests.csproj
```
